...
processor = WhisperProcessor.from_pretrained(MODEL_ID, language="Malay", task="transcribe")
...
for s_ratio, r_ratio in proportions:
    ...
    variant_name = f"openai_small_S{s_label}_R{r_label}"
    ...
    print(f"Variant saved to {output_dir}")