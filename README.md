# FYP-ASR-Lab
This repo is to store the ASR Lab system for FYP, due to file size limitations. 
...
5. Run main.py and wait for interface.
6. Your models are ready and the application is ready to use.
